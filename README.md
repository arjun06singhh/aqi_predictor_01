...
bash python air_quality_companion.py Instructions for Testing Test 1: Basic Functionality Run the application: python air_quality_companion.py
...
Test 2: Different Air Quality Scenarios Test with various PM2.5 levels to see different recommendations:
...
Test 3: Quick Analysis Function python from air_quality_companion import quick_air_lookup

## Test the quick analysis function
result = quick_air_lookup(35, 65) print(f"AQI: {result['aqi']}") print(f"Recommendation: {result['suggestion']}") Test 4: Data Validation Ensure city_day.csv is properly loaded
